const slides = [
  ...
  },
  {
    ...
    centerLine: '传统汽车 = 功能手机 ｜ SDV = 智能手机',
    bottom: '本质：从「一次性交付」到「持续价值运营」',
    revealCount: 1,
    note: '≤10字/行。底部「本质」一句先隐藏，按一次空格/点击后揭晓，再按一次进入下一页。',
    chapter: '开场'
  },
  {
    id: 5,
  ...
  },
  {
    ...
    content: [
      ...
      '',
      '结论（先给出判断）：',
      '<b>电动化首先改变的是“价值定义方式”，而不是软件本身。</b>',
      '',
      '→ 传统机械优势被削弱',
      '→ 新价值锚点不完全由奔驰主导',
      '',
      '下面用一张图把成本结构和控制权变化讲清楚'
    ],
    layout: 'left',
    image: null,
  ...
  },
  {
    ...
    content: [
      ...
      '',
      '这不是一次技术升级，而是一场控制权的重新分配：<b>谁控制核心成本，谁就控制行业。</b>'
    ],
    layout: 'left',
    image: null,
    note: '转折点。「权力重组」概括全文。',
  ...
  },
  {
    ...
    content: [
      ...
      '',
      '我的观察：<b>奔驰已经在“做软件”，但还没有完全“按软件公司的方式运作”。</b> 问题不在决心，而在组织结构与决策机制的惯性。'
    ],
    layout: 'left',
    image: null,
  ...
  },
  {
    ...
    content: [
      ...
      '',
      '进一步抽象来看：',
      '<b>燃油车时代的豪华 = 工程能力定义；电动车时代的豪华 = 软件体验 + 用户界面 + 智能能力。</b>',
      '问题在于：奔驰擅长定义“机械豪华”，但新的豪华标准，不再完全由它定义。'
    ],
    layout: 'left',
    image: null,
  ...
  },
  {
    ...
    content: [
      '如果只是产品问题，影响不会这么大；但财务数据说明它已经变成经营问题：',
  ...
  },
  {
    ...
    content: [
      ...
      '<b>SDV 的本质不是去依赖，而是：从旧依赖，走向新依赖。</b>'
    ],
    layout: 'left',
    image: null,
  ...
  },
  {
    id: 22,
    type: 'content',
    title: '奔驰的三条可能路径（战略收束）',
    content: [
      '路径一：工程驱动（稳）—— 自动驾驶、安全心智',
      '路径二：平台驱动（关键）—— MB.OS、软件复用、长期降本',
      '路径三：商业模式（探索）—— OTA/订阅，但服务整车溢价',
      '',
      '<b>核心问题不是选哪条路径，而是谁来定义未来的价值。</b>'
    ],
    layout: 'left',
    image: null,
    note: '快速收束，不展开讲。作为进入真实故事前的战略总结。',
    chapter: '第四章 机遇'
  },
  {
    id: 23,
  ...
  },
  {
    ...
    content: [
      ...
      '',
      '<b>总结：产品与成本解释当下，SDV 解释为什么过去的优势开始失效。</b>'
    ],
    layout: 'left',
    image: null,
  ...
  },
  {
    ...
    note: '',
    content: [
      '讨论：你所在行业，是否也在经历“核心能力转移”的过程？',
      '讨论：你的产品价值，是由你定义，还是被平台/供应链重新定义？'
    ],
    chapter: ''
  }
]
